...
translate([0, lineWidth * 0, 0])
 ...
 // Pin name : Condition, pin side : left, pin line : 2, pin type : bool
...
translate([-12,  -lineWidth * 2, 0]) {
 ...
 // Pin name : False, pin side : right, pin line : 2, pin type : exec
translate([0, +lineWidth * 1, 0])
    rotate([180,180,90]) 
...
translate([-12,  +lineWidth * 0, 0]) {
 ...
 // Pin name : , pin side : left, pin line : 3, pin type : exec
translate([-12,  -lineWidth * 3, 0]) {
        executePin(4, 4);
}
 // Pin name : True, pin side : right, pin line : 3, pin type : exec
