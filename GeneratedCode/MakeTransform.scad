...
translate([0, lineWidth * 0, 0])
        rotate([180,180,90]) 
 printTextAndBraille("Make Transform");
 // Pin name : Scale, pin side : left, pin line : 2, pin type : struct
...
translate([-12,  +lineWidth * 0, 0]) {
 ...
 // Pin name : Rotation, pin side : left, pin line : 3, pin type : struct
...
translate([-12,  -lineWidth * 3, 0]) {
 ...
 // Pin name : Location, pin side : left, pin line : 4, pin type : struct
