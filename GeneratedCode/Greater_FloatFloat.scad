...
translate([0, lineWidth * 0, 0])
        rotate([180,180,90]) 
 printTextAndBraille("Greater_ Float Float");
 // Pin name : A, pin side : left, pin line : 2, pin type : float
...
translate([-12,  -lineWidth * 2, 0]) {
 ...
 // Pin name : Return Value, pin side : right, pin line : 2, pin type : bool
translate([0, +lineWidth * 1, 0])
    rotate([180,180,90]) 
...
translate([-12,  +lineWidth * 0, 0]) {
 ...
 // Pin name : B, pin side : left, pin line : 3, pin type : float
